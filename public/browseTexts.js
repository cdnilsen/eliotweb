        ...
        for (let j = 0; j < numOfVerses; j++) {
            ...
            for (let k = 0; k < usefulPrimes.length; k++) {
                ...
                if (p == 43 && !addedVerseNumber) {
                    ...
                    verseNumColumn.style = 'grid-column: ' + (k + 1).toString() + '; text-align: center; font-weight: bold; font-size: 36px';
                ...
                thisVerseColumn.style = "grid-column: " + (k + 1).toString() + "; font-size: 48px;";
